...
public class U2_R2_Ej11_Victor { //Victor Stala
    public static void main (String[]args) {
        /* 
        Escribe una aplicacion que solicite al usuario un numero comprendido entre 0 y 9999. La aplicacion tendra que indicar si el numero introducido es capicua.
        */
        //Variables
		...
		num=teclado.nextInt();
		//Dividimos el numero para comparar cada digito.
		millares=num/1000;
		...
		//Comparamos si es capicua
				...
				if(num<100)
					...
					if(num<1000)
						...
						capicua=((unidades==millares)&&(decenas==centenas)) ? true : false;
		if(valido==false)
			System.out.println("El número no esta en el rango establecido o es un numero de 1 digito.");
		else
			if(capicua==true)
