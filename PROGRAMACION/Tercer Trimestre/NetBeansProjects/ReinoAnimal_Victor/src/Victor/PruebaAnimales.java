...
public class PruebaAnimales {
    ...
    public static void gatosCreados(){
        ...
        do {
            ...
            switch (opcion) {
                ...
                case '3': //eliminar gato
                    try {
                        System.out.println("Dime la posicion de la cual quieras eliminar un gato (0-"+listaGatos.size()+"): ");
                ...
                case '5': //consultar posicion
                    try {
                        System.out.println("Dime la posicion de la cual quieras consultar el gato (0-"+listaGatos.size()+"): ");
                        pos = new Scanner(System.in).nextInt();
                        listaGatos.get(pos).toString();
                    } catch (InputMismatchException e) {
                        System.out.println("Caracter insertado erróneo.");
                    }
                    break;
    ...
    public static Gatos gatoUsuario(){
        ...
        try {
            ...
            System.out.println("Se creado la fecha correctamente...");
            return gato;
        } catch (InputMismatchException e) {
